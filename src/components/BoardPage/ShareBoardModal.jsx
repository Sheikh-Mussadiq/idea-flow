...
export const ShareBoardModal = ({ isOpen, onClose, board }) => {
  ...
  const [members, setMembers] = useState([
    { id: 1, name: "You", email: "you@example.com", role: "admin", avatar: "YO" },
    { id: 2, name: "Sarah Johnson", email: "sarah@example.com", role: "editor", avatar: "SJ" },
    { id: 3, name: "Mike Chen", email: "mike@example.com", role: "viewer", avatar: "MC" },
  ]);
  ...
  const handleCopyLink = () => {
    navigator.clipboard.writeText(`https://ideaflow.app/board/${board?.id || "123"}`);
    setCopied(true);
            ...
            <div className="space-y-4">
              <form onSubmit={handleInvite} className="flex gap-2">
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button variant="outline" className="w-24 dark:border-neutral-700 dark:text-neutral-300 dark:hover:bg-neutral-800">
                      {inviteRole === "admin" ? "Admin" : inviteRole === "editor" ? "Editor" : "Viewer"}
                    </Button>
                  </DropdownMenuTrigger>
                  <DropdownMenuContent align="end" className="dark:bg-neutral-900 dark:border-neutral-700">
                    <DropdownMenuItem onClick={() => setInviteRole("viewer")} className="dark:text-neutral-200 dark:hover:bg-neutral-800">Viewer</DropdownMenuItem>
                    <DropdownMenuItem onClick={() => setInviteRole("editor")} className="dark:text-neutral-200 dark:hover:bg-neutral-800">Editor</DropdownMenuItem>
                    <DropdownMenuItem onClick={() => setInviteRole("admin")} className="dark:text-neutral-200 dark:hover:bg-neutral-800">Admin</DropdownMenuItem>
                  </DropdownMenuContent>
                </DropdownMenu>
              ...
              <div className="flex items-center gap-2 p-3 bg-neutral-50 dark:bg-neutral-800/50 rounded-lg border border-neutral-200 dark:border-neutral-700">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-xs font-medium text-neutral-500 dark:text-neutral-400">Anyone with the link can view</p>
                  <p className="text-sm text-neutral-900 dark:text-white truncate">https://ideaflow.app/board/{board?.id || "123"}</p>
                </div>
                <Button
                  variant="ghost"
                  size="sm"
                  ...
                  <div key={member.id} className="flex items-center justify-between group">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm font-medium text-neutral-900 dark:text-white">
                          {member.name} {member.id === 1 && <span className="text-neutral-400 font-normal">(you)</span>}
                        </p>
                    ...
                    <div className="flex items-center gap-2">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="dark:bg-neutral-900 dark:border-neutral-700">
                          <DropdownMenuItem onClick={() => handleUpdateRole(member.id, "viewer")} className="dark:text-neutral-200 dark:hover:bg-neutral-800">Viewer</DropdownMenuItem>
                          <DropdownMenuItem onClick={() => handleUpdateRole(member.id, "editor")} className="dark:text-neutral-200 dark:hover:bg-neutral-800">Editor</DropdownMenuItem>
                          <DropdownMenuItem onClick={() => handleUpdateRole(member.id, "admin")} className="dark:text-neutral-200 dark:hover:bg-neutral-800">Admin</DropdownMenuItem>
                        </DropdownMenuContent>
                      </DropdownMenu>
