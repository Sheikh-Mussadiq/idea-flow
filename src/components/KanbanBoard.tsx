...
export const KanbanBoard = ({
  ...
  const ideasByStatus: Record<KanbanStatus, KanbanBoardIdea[]> = {
    Backlog: [],
    "In Progress": [],
    Review: [],
    Done: [],
                              ...
                              return (
                                <div className="flex items-center justify-between mb-1 text-[11px] text-muted-foreground">
                                  <div className="flex items-center gap-2">
                                    {idea.priority && (
                                      <span
                                        className={`inline-flex items-center gap-1 px-1.5 py-0.5 rounded-full bg-muted/80`}
                                      >
                                        <span
