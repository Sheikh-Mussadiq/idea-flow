...
export const BranchingIdeaCard = ({
  ...
  return (
    ...
    >
      {/* Connector Line */}
      <div className="w-0.5 h-12 bg-gradient-to-b from-neutral-200 to-transparent mb-4" />

      {/* Card */}
      <div
        onClick={onOpenComments}
        className="group relative bg-white rounded-2xl p-6 shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer w-full max-w-[320px] border border-neutral-200/60"
      >
        {/* Badge */}
        <Badge
